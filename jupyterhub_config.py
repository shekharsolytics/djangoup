...
#
# BaseHandler.__bases__ = (CORSMixin, ) + BaseHandler.__bases__
...
#         print("hi")
#         query_params = parse_qs(handler.request.query)
#         print(query_params)
#         print(query_params.get('next'))
...
#
# c.Authenticator.allowed_users = {'shekharsolytics'}
#
#
# c.JupyterHub.authenticator_class = GitHubOAuthenticator
# c.GitHubOAuthenticator.client_id = '921f27b5a5f18e43fe05'
# c.GitHubOAuthenticator.client_secret = 'd03107fea6e1d5492f93c90b090019a7b27eebb0'
...
c.JupyterHub.api_tokens = {
    'c2f7f10e765b4f8da7029e77e2a3ad15': 'admin'
}
...
# c.JupyterHub.db_url = 'postgresql+psycopg2://postgres:postgres@localhost:5432/jupyterdb'
